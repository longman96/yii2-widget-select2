...
class InputWidget extends \yii\widgets\InputWidget
{
     ...
     * Generates an input
     */
    protected function getInput($type, $list = false, $longman = false)
    {
        ...
        if ($this->hasModel()) {
            ...
            if($longman === true){
                if(Html::getAttributeValue($this->model, $this->attribute) != '') {
                    $a = implode(",", Html::getAttributeValue($this->model, $this->attribute));
                } else {
                    $a = '';
                }

                echo '<input type="hidden" id="initialLoadValues" value="'.$a.'" />';
            }
